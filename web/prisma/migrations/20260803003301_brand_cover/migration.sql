...
INSERT INTO "new_Guide" ("createdAt", "id", "isPublic", "publicSlug", "steps", "title", "updatedAt", "userId") SELECT "createdAt", "id", "isPublic", "publicSlug", "steps", "title", "updatedAt", "userId" FROM "Guide";
DROP TABLE "Guide";
